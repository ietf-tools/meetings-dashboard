...
return array(
    ...
    // Meta
    'meta'    => array(
        'title'       => 'IETF Meetings Dashboard',
        'description' => 'IETF Virtual Meetings Dashboard, displaying all the fun information points for the participation and monitoring of the meeting.',
        'keywords'    => 'IETF, RFCs, IETF Dashboard, IETF Virtual Meeting',
        'canonical'   => 'https://dashboard.ietf.linespeed.com',
    ...
    'layout'  => array(
        ...
        'toolbar'    => array(
            ...
            'layout'  => 'toolbar-3', // Set toolbar type
            'layouts' => array(
                'toolbar-1' => array(
                    'height'                   => '55px',
