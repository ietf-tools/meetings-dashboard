...
<button
    ...
    class="btn btn-sm btn-white btn-active-primary shadow-sm position-fixed px-5 fw-bolder zindex-2 top-50 mt-10 end-0 transform-90"
	...
	<div class="card shadow-none w-100">
		...
		<div class="card-body" id="kt_explore_body">
			...
			<div
                ...
                <!--begin::Demos-->
                <div class="mb-0">
                    <?php foreach(theme()->getOption('product', 'demos') as $id => $demo):?>
                        <!--begin::Demo-->
                        <div class="mb-7">
                            ...
                            <div class="overlay overflow-hidden border border-4 <?php util()->putIf($id === theme()->getDemo(), 'border-primary', '')?> p-2 rounded">
                                <?php if($demo['published'] === true):?>
                                    <div class="overlay-wrapper rounded">
                                        <img src="{{ asset('media/'.$demo["thumbnail"]) }}" alt="demo" class="w-100 rounded"/>
                                    </div>
                                ...
                                <?php else:?>
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('media/'.$demo["thumbnail"]) }}" alt="demo" class="w-100 rounded opacity-75"/>
                                    </div>
