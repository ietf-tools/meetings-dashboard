...
{{ theme()->getView('pages/account/overview/_details', array('class' => 'mb-5 mb-xl-10', 'info' => App\Models\Participant::where('email', auth()->user()->email)->orderBy('meetingID', 'desc')->first())) }}
